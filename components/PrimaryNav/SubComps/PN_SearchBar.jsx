  ...
  return (
    <form className="flex items-center w-full h-full">
      ...
      <div class="relative w-full">
        ...
        {/* <button
          type="submit"
          class="text-white absolute right-1.5 bottom-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-xs px-4 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Search
        </button> */}
      </div>
